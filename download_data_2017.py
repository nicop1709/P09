"""Script pour télécharger les données BTC/USDC 2017-2025 (maximum de données)"""
import ccxt
import pandas as pd
...
if __name__ == "__main__":
    df = fetch_ohlcv_binance("BTC/USDC", "1h", 2017, 2025)
    filename = "btc_usdc_1h_2017_2025.csv"
